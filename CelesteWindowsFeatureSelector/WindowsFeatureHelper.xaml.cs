    ...
    public partial class WindowsFeatureHelper : Window
    {
        ...
        private async void EnableDirectPlayBtnClick(object sender, RoutedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                GenericMessageDialog.Show(Celeste_Launcher_Gui.Properties.Resources.GenericUnexpectedErrorMessage, DialogIcon.Error, DialogOptions.OkWithLog, Celeste_Public_Api.Logging.LogHelper.FindMostRecentLogFile(System.IO.Path.Combine("Logs", "windows-features.log")));
            }
            IsEnabled = true;
        }
